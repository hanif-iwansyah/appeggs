package com.hindustries.repository.domain.operasional.production;
...
public interface ProduksiTelurRepository extends JpaRepository<ProduksiTelur, Long> {
    ...
    @Query("""
           SELECT new com.hindustries.dto.response.domain.operasional.production.ProduksiTelurSummaryResponse(
               p.kelompokAyam.id,
